...
2. Deploy Django API to IIS
    ...
    - Open "FastCGI Settings" in Computer/Username eg) ME-PC\dadac
    ...
    - Click Restart then Click Browse Website eg) Browse 192.168.1.130:8200(http)
    
    - Troubleshooting
        1. DisallowedHost at /
            -> Add a new host to ALLOWED_HOSTS in settings.py
                eg) ALLOWED_HOSTS = ['192.168.1.130', 'localhost']
        ...
        3. The Web server is configured to not list the contents of this directory.
            ...
            -> Click Yes if need to create a new one then enter Enviorment Variables
    ...
    4. Deploy React App to IIS
        ...
        - Enter "Site name", "Physical path", "IP Address", "Port"
            ...
            Port: 8200
        - Open Browse Website: eg) Real IP Address:8200
